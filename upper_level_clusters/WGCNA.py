...
pywgcna.findModules()
modules_df = pywgcna.datExpr.var[['moduleColors']]

modules_df = modules_df.reset_index().rename(columns={'index': 'gene'})

wgcna_module_dict = modules_df.groupby('moduleColors')['gene'].apply(list).to_dict()
